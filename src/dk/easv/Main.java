...
import dk.easv.sequential.SequentialIteratorCollection;
...
public class Main {
    ...
    private static void sequentialIterator() {
        System.out.println();
        System.out.println("--- SEQUENTIAL ITERATOR ---");

        IIterableCollection collection = new SequentialIteratorCollection(1, 2, 3, 4, 5, 6);
